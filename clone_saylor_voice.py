...
CHARACTER_VOICES = {
    ...
    "Jeffrey Epstein": {
        "audio_file": "jeffrey_epstein_audio.mp3",  # You'll need to provide this file
        "description": "Mysterious philanthropist and financier, enigmatic and sophisticated voice",
        "labels": '{"accent": "american", "age": "middle-aged", "gender": "male", "use_case": "intellectual"}'
    }
}
