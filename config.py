...
MODEL_NAME = os.getenv("MODEL_NAME", "gpt-4o-mini")  # gpt-4o-mini is faster than gpt-4
...
# Character Settings
CHARACTER_NAME = os.getenv("CHARACTER_NAME", "Jeffrey Epstein")
CHARACTER_PERSONALITY = os.getenv("CHARACTER_PERSONALITY", "jeffrey_epstein")
